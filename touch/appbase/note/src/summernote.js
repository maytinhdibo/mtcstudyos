...
(function (factory) {
  ...
  var settings = {
    ...
    options: {
      ...
      // language
      lang: 'vi-VN',                // language 'en-US', 'ko-KR', ...
      ...
      toolbar: [
        ['style', ['style']],
		['misc',['undo','redo', 'help']],
        ['font', ['fontsize', 'bold', 'italic', 'underline', 'superscript', 'subscript', 'strikethrough', 'clear']],
        ['fontname', ['fontname']],		
      ...
      fontNames: [
        ...
        'Tahoma', 'Times New Roman', 'SeogoeUI', 'Verdana'
      ],
      ...
      // fontSize
      fontSizes: ['6','8', '9', '10', '11', '12', '14', '18', '24', '36','72'],
...
//mtc
      ...
      'ENTER': 'Chọn đoạn',
          ...
          'CTRL+I': 'Thường',
          'CTRL+U': 'Gạch chân',
          'CTRL+SHIFT+S': 'Đường xuyên qua',
          'CTRL+BACKSLASH':'Xóa định dạng',
          'CTRL+SHIFT+L': 'Căn lề trái',
          'CTRL+SHIFT+E': 'Căn giữa',
          'CTRL+SHIFT+R': 'Căn phải',
          'CTRL+SHIFT+J': 'Căn đều hai bên',
          'CTRL+SHIFT+NUM7': 'insertUnorderedList',
          'CTRL+SHIFT+NUM8': 'insertOrderedList',
          'CTRL+LEFTBRACKET': 'ngoài',
          'CTRL+RIGHTBRACKET': 'bên trong',
             'CTRL+NUM0': 'định dạngPara',
          'CTRL+NUM1': 'định dạng H1',
          'CTRL+NUM2': 'định dạngH2',
          'CTRL+NUM3': 'định dạngH3',
          'CTRL+NUM4': 'formatH4',
          'CTRL+NUM5': 'định dạng H5',
          'CTRL+NUM6': 'định dạng H6',
          'CTRL+ENTER': 'chọn thanh thước ngang',
          'CTRL+K': 'hiển thị liên kết'
        },

          mac: {
          'ENTER': 'Chọn đoạn văn bản',
          'CMD+Z': 'Trở về',
          'CMD+SHIFT+Z': 'Tiếp',
          'TAB': ' Chọn Tab',
          'SHIFT+TAB': 'Bỏ tab',
          ...
          'CMD+I': 'Nghiêng',
          'CMD+U': 'Gạch chân',
          'CMD+SHIFT+S': 'Đường xuyên qua',
          'CMD+BACKSLASH': 'Xóa định dạng',
          'CMD+SHIFT+L': 'Căn trái',
          'CMD+SHIFT+E': 'Căn giữa',
          'CMD+SHIFT+R': 'Căn phải',
          'CMD+SHIFT+J': 'Căn đều hai bên',
          'CMD+SHIFT+NUM7': 'chọn danh sách không sắp xếp',
          'CMD+SHIFT+NUM8': 'chọn danh sách sắp xếp',
          'CMD+LEFTBRACKET': 'ngoài',
          'CMD+RIGHTBRACKET': 'bên trong',
          'CMD+NUM0': 'định dạng Para',
          'CMD+NUM1': 'định dạng H1',
          'CMD+NUM2': 'định dạng H2',
          'CMD+NUM3': 'định dạng H3',
          'CMD+NUM4': 'định dạng H4',
          'CMD+NUM5': 'định dạng H5',
          'CMD+NUM6': 'định dạng H6',
          'CMD+ENTER': 'Chọn thanh thước ngang',
          'CMD+K': 'Hiển thị liên kết'
        }
      }
    },
    ...
    lang: {
      'vi-VN': {
        ...
        image: {
          image: 'Hình ảnh',
          insert: 'Chọn hình ảnh',
          resizeFull: 'toàn hình ảnh',
          resizeHalf: 'Một nửa hình ảnh',
          resizeQuarter: 'Một phần tư hình ảnh',
          floatLeft: 'nổi trái',
          floatRight: 'Nổi phải',
          floatNone: 'Không nổi',
          shapeRounded: 'tròn',
          shapeCircle: 'vòng',
          shapeThumbnail: 'thu nhỏ',
          shapeNone: 'không chon shap',
          dragImageHere: 'kéo một hình ảnh ở đây',
        ...
        color: {
          recent: 'các màu đã chọn gần đây',
          more: 'Chọn các màu khác',
          background:'màu nền',
          foreground: 'đặt màu nền',
          transparent: 'Transparent',
          setTransparent: 'Set transparent',
          reset: 'Khởi động lại',
          resetToDefault: 'khởi động mặc định'
        },
        shortcut: {
          shortcuts: 'phím tắt',
          close: 'Đóng',
          textFormatting: 'Văn bản đang định dạng',
          action: 'Nút',
          paragraphFormatting: 'Đoạn đang định dạng',
          documentStyle: 'Kiểu tài liệu'
        },
        history: {
          undo: 'khôi phục',
          redo: 'tiếp'
...
//mtc
  ...
  var Renderer = function () {
    ...
    var tplDialogs = function (lang, options) {
      ...
      var tplHelpDialog = function () {
        var body = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + lang.shortcut.close + '</a>' +
                   ...
                   '<p class="text-center">' +
                     'Sản phẩm của Mtc, dựa trên mã nguồn <a href="//hackerwins.github.io/summernote/" target="_blank">Summernote 0.5.10</a> · ' +                     
                   '</p>';
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      var $editable = $('<div id="note-editable" class="note-editable" contentEditable="' + isContentEditable + '"></div>')
          .prependTo($editor);
      if (options.height) {
      ...
      toolbarHTML = '<div id="note-toolbar" class="note-toolbar btn-toolbar">' + toolbarHTML + '</div>';
