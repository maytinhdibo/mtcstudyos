...
kq="<h2>Kết quả:</h2>"+kq+"<br><a style='color:#fbfbfb' href='https://vi.wikipedia.org/wiki/Ph%C6%B0%C6%A1ng_tr%C3%ACnh_tuy%E1%BA%BFn_t%C3%ADnh'>Xem thêm về phương trình tuyến tính</a>";
document.getElementById('kqdis').innerHTML=kq;
opkq();
}